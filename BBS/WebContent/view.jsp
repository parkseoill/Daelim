	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="main.jsp">
				<p style="font-weight: bold">대림대학교</p>
			</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<% if (boardID == 1){ %>
					<li class="active"><a href="bbs.jsp?boardID=1&pageNumber=1">정보 공유</a></li>
			...
			<table class="table table-haver" style="border: 1px solid #dddddd">
				...
				%>
					...
					<tr align="center">
						...
						<td colspan="2"><button onclick="location.href='evaluationAction.jsp?likeEat=0&sosoEat=0&badEat=1&bbsID=<%=bbsID%>'">별로에요(<%=bad %>)</button></td>		
					</tr>
					<tr>
					<%
						}
