...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="main.jsp">
				<p style="font-weight: bold">대림 대학교</p>
			</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<% if (boardID == 1){ %>
					<li class="active"><a href="bbs.jsp?boardID=1">정보 공유</a></li>
					<li><a href="bbs.jsp?boardID=2">자유 게시판</a></li>
				<%} else if(boardID == 2){ %>
					<li><a href="bbs.jsp?boardID=1">정버 공유</a></li>
	...
	%>
			<h1>정보 공유<br></h1>
			<p>정보 공유하는 페이지입니다. 서로 정보 공유합시다!<br><br></p>
	<% }
		else if(boardID == 2){
	%>
			<h1>자유게시판<br></h1>
